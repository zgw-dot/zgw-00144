...
from .models import DefectRecord, SourceRow, generate_defect_id
...
def merge_source_rows_into_defects(
    ...
    return result, new_count, merged_count
...
def import_and_merge(
    ...
    merged, new_count, merged_count = merge_source_rows_into_defects(valid_rows, config, current_defects)
